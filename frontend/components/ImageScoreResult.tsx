import { imageUrl, type ImageQuizQuestion, type SubmitResult } from "@/lib/api";

export default function ImageScoreResult({
  result,
  questions,
  onRetake,
}: {
          ...
          return (
            <li key={r.question_id} className="glass-card flex items-center gap-3 p-3">
              ...
              <img
                ...
                alt={`Question ${idx + 1}`}
                className="h-16 w-16 shrink-0 rounded-lg border border-[var(--hairline)] object-cover"
              />
