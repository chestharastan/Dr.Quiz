...
def extract_structure(image: np.ndarray) -> TableStructure | None:
    ...
    cols = find_column_boundaries(bw)
...
def tight_crop(
    ...
    at the cell edges. Used for the number and answer-letter cells, whose
    row band is much taller than the single glyph(s) they contain."""
    y0, y1 = y_range
    x0, x1 = x_range
